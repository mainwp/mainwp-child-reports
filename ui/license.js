	...
	var	i = $( '<iframe>' ).appendTo( 'body' ),
		...
		got_license = function( license ) {
			...
			$.ajax({
				url: ajaxurl,
				type: 'post',
				data: { action: 'mainwp-stream-license-check', license: license, nonce: stream_activation.nonce.license_check },
				dataType: 'json',
				success: function( r ) {
		...
		disconnect = function() {
			...
			$.ajax({
				url: ajaxurl,
				type: 'post',
				data: { action: 'mainwp-stream-license-remove', nonce: stream_activation.nonce.license_remove },
				dataType: 'json',
				success: function( r ) {
					spinner.hide();
					if ( r.success ) {
