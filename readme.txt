...
* Tweak: Add wp_mainwp_stream_is_record_excluded filter. ([#921](https://github.com/xwp/stream/pull/921))
...
* Fix: Handle boolean values appropriately during wp_mainwp_stream_log_data filter ([#680](https://github.com/wp-stream/stream/issues/680))
