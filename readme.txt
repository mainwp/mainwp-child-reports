...
3. **Issue Pull Requests:** If you're a developer, the easiest way to get involved is to help out on [issues already reported](https://github.com/wp-stream/stream/issues) in GitHub. Be sure to check out the [contributing guide](https://github.com/wp-stream/stream/blob/master/contributing.md) for developers.
...
* Fix: Revert delayed log mechanism for post transition ([#585](https://github.com/wp-stream/stream/issues/585))
* Fix: Revert usage of get_taxonomy() ([#586](https://github.com/wp-stream/stream/pull/586))
* Fix: Notices not firing on correct action ([#589](https://github.com/wp-stream/stream/issues/589))

Props [shadyvb](http://profiles.wordpress.org/shadyvb/), [fjarrett](http://profiles.wordpress.org/fjarrett/)

= 1.4.8 - July 18, 2014 =

* New: Greatly improved widget tracking, including changes performed in Customizer ([#391](https://github.com/wp-stream/stream/pull/391))
* New: Now tracking when Akismet automatically marks comments as spam ([#587](https://github.com/wp-stream/stream/pull/587))
* Tweak: Log WP-CLI details to Stream author meta ([#470](https://github.com/wp-stream/stream/issues/470))
* Tweak: Track changes to options more deeply ([#573](https://github.com/wp-stream/stream/pull/573))
* Fix: Labels not seen for CPT registered on init with default priority ([#565](https://github.com/wp-stream/stream/issues/565))
* Fix: Stream menu appearing in Network menu when not network activated ([#582](https://github.com/wp-stream/stream/issues/582))
* Fix: Post Revision ID associated to record is not the most recent one ([#585](https://github.com/wp-stream/stream/issues/585))
* Fix: Incorrect action label for comment throttling ([#591](https://github.com/wp-stream/stream/issues/591))
...
* New: Comment Type support added to the Comments connector ([#558](https://github.com/wp-stream/stream/issues/558))
* Fix: Datepicker opens again with each paged view ([#568](https://github.com/wp-stream/stream/issues/568))
* Fix: PHP warning when deleting network users ([#579](https://github.com/wp-stream/stream/issues/579))
* Fix: Track user count setting changes ([#583](https://github.com/wp-stream/stream/issues/583))
* Fix: .po and .pot files out-of-date for translators ([#584](https://github.com/wp-stream/stream/issues/584))
...
* Tweak: Actions provided for trashed posts are irrelevant ([#523](https://github.com/wp-stream/stream/issues/523))
* Tweak: Use core language pack translations where possible ([#534](https://github.com/wp-stream/stream/issues/534))
* Tweak: Consolidate show filter and show column screen options ([#542](https://github.com/wp-stream/stream/issues/542))
* Tweak: Stop tracking failed login attempts ([#547](https://github.com/wp-stream/stream/issues/547))
* Tweak: Remove all uses of extract() from Stream ([#556](https://github.com/wp-stream/stream/issues/556))
* Fix: Excluding roles is not handled properly ([#527](https://github.com/wp-stream/stream/issues/527))
* Fix: Stream runs install routine twice ([#528](https://github.com/wp-stream/stream/issues/528))
* Fix: Widget records show sidebar slug instead of label ([#531](https://github.com/wp-stream/stream/issues/531))
* Fix: Fatal error when PHP version is less than 5.3 ([#538](https://github.com/wp-stream/stream/issues/538))
* Fix: Cannot exclude Custom Background context ([#543](https://github.com/wp-stream/stream/issues/543))
* Fix: Conflict with Jetpack body class in WP Admin ([#545](https://github.com/wp-stream/stream/issues/545))
* Fix: Stream settings exclude error for big wp_users table ([#551](https://github.com/wp-stream/stream/issues/551))
...
* New: Lightweight frontend indicator for sites using Stream ([#507](https://github.com/wp-stream/stream/issues/507))
* Tweak: Add filterable method for excluded comment types ([#487](https://github.com/wp-stream/stream/issues/487))
* Tweak: Rename "ID" column label to "Record ID" ([#490](https://github.com/wp-stream/stream/issues/490))
* Tweak: One admin notice for any missing DB tables ([#506](https://github.com/wp-stream/stream/pull/506))
* Fix: Custom authentication schemes not tracking user logins correctly ([#434](https://github.com/wp-stream/stream/issues/434))
* Fix: Taxonomy connector conflicts with Edit Flow plugin ([#498](https://github.com/wp-stream/stream/issues/498))
* Fix: Switching user is incorrectly tracked ([#501](https://github.com/wp-stream/stream/issues/501))
* Fix: Extension activation links broken when plugin folders are renamed ([#502](https://github.com/wp-stream/stream/issues/502))
* Fix: Author info showing up incorrectly ([#505](https://github.com/wp-stream/stream/issues/505))
* Fix: Incompatibility with multi-server environments ([#517](https://github.com/wp-stream/stream/issues/517))
* Fix: Warnings seen when Show Avatars is disabled ([#518](https://github.com/wp-stream/stream/issues/518))
* Fix: Notices for non-existent extension data after timeout ([#529](https://github.com/wp-stream/stream/pull/529))
...
* New: Admin pointers to highlight when new admin screens are introduced ([#466](https://github.com/wp-stream/stream/issues/466))
* Tweak: Filter introduced to allow the Stream admin menu position to be changed ([#99](https://github.com/wp-stream/stream/issues/99))
* Tweak: Provide option label for records that show when the Stream database has updated ([#444](https://github.com/wp-stream/stream/pull/444))
* Tweak: Better handling of authors in the list table ([#448](https://github.com/wp-stream/stream/pull/448))
* Tweak: Way for developers to set their Stream Extensions affiliate ID on links from the Extensions screen ([#482](https://github.com/wp-stream/stream/issues/482))
* Fix: Extensions screen CSS bug in Firefox ([#464](https://github.com/wp-stream/stream/issues/464))
* Fix: Error when installing extensions from the Network Admin ([#491](https://github.com/wp-stream/stream/issues/491))
* Fix: Undefined notice in admin.php ([#468](https://github.com/wp-stream/stream/issues/468))
...
* New: Introducing the Stream Extensions screen! ([#396](https://github.com/wp-stream/stream/issues/396))
...
* Fix: Update Database button redirecting to previous screen ([#443](https://github.com/wp-stream/stream/issues/443))
* Fix: Update routine hotfix that was causing records to disappear ([#447](https://github.com/wp-stream/stream/issues/447))
...
* Fix: Scripts and styles not using Stream version number ([#440](https://github.com/wp-stream/stream/issues/440))
* Fix: WP-CLI incorrectly referenced in records ([#441](https://github.com/wp-stream/stream/issues/441))

Props [westonruter](http://profiles.wordpress.org/westonruter/), [fjarrett](http://profiles.wordpress.org/fjarrett/)

= 1.4.0 - April 24, 2014 =

* New: Multisite is now fully supported, activate Stream network-wide ([#65](https://github.com/wp-stream/stream/issues/65))
* New: Separate API for handling DB update routines ([#379](https://github.com/wp-stream/stream/issues/379))
* New: WP-CLI compatibility, Stream now tracks changes made via WP-CLI ([#423](https://github.com/wp-stream/stream/issues/423))
* Tweak: Deprecate functions and hooks in favor of consistent naming conventions ([#267](https://github.com/wp-stream/stream/issues/267))
* Tweak: Use icon link instead of clicking the summary to filter by object ID ([#380](https://github.com/wp-stream/stream/issues/380))
* Tweak: Save additional author meta for better records ([#389](https://github.com/wp-stream/stream/issues/389))
* Tweak: More compact search filters for smaller screens ([#403](https://github.com/wp-stream/stream/issues/403))
* Fix: Fix AJAX loading of authors in dropdown filters ([#49](https://github.com/wp-stream/stream/issues/49))
* Fix: Custom capability conflict with W3 Total Cache plugin ([#296](https://github.com/wp-stream/stream/issues/296))
* Fix: Live updates remove last item in activity table ([#386](https://github.com/wp-stream/stream/issues/386))
* Fix: Live updates screen option checkbox not persisting ([#392](https://github.com/wp-stream/stream/issues/392))
* Fix: IP validator not respecting zero ([#394](https://github.com/wp-stream/stream/issues/394))
* Fix: Non-Administrator users seeing errors in Settings records ([#406](https://github.com/wp-stream/stream/issues/406))
* Fix: Uninstall confirmation message doesn't display ([#411](https://github.com/wp-stream/stream/issues/411))
* Fix: TTL purge schedule is never setup ([#412](https://github.com/wp-stream/stream/issues/412))
* Fix: NextGen compability issue ([#416](https://github.com/wp-stream/stream/issues/416))
* Fix: Stream Feeds Key not being automatically generated ([#420](https://github.com/wp-stream/stream/issues/420))
...
* New: Theme Editor connector for tracking changes made to theme files ([#313](https://github.com/wp-stream/stream/issues/313))
* New: Additional screen options to show/hide only the filters you care about ([#329](https://github.com/wp-stream/stream/issues/329))
* New: Visibility option in Exclude settings to hide past records from view ([#355](https://github.com/wp-stream/stream/issues/355))
* New: Stream Activity dashboard widget now supports live updates ([#356](https://github.com/wp-stream/stream/issues/356))
* New: Hover authors to reveal a tooltip with helpful user meta ([#338](https://github.com/wp-stream/stream/issues/338))
* New: Hover roles to reveal a tooltip with the number of authors assigned to that role ([#377](https://github.com/wp-stream/stream/issues/377))
* Tweak: Future dates now disabled in Start date field datepicker ([#334](https://github.com/wp-stream/stream/issues/334))
* Tweak: Now showing user Gravatars in Exclude Authors & Roles settings field ([#333](https://github.com/wp-stream/stream/issues/333))
* Tweak: ID column is now hidden by default in Screen Options ([#348](https://github.com/wp-stream/stream/issues/348))
* Tweak: Widget updated summary message improvement ([8818976](https://github.com/wp-stream/stream/commit/88189761d4a8836038e8d9ec348096a0aab3072d))
* Fix: Autocomplete not working correctly in Exclude IP Addressees settings field ([#335](https://github.com/wp-stream/stream/issues/335))
* Fix: Reset Stream Database link not clearing everything in all cases ([#347](https://github.com/wp-stream/stream/issues/347))
* Fix: PHP 5.3.3 compatibility issue with filter constant ([#351](https://github.com/wp-stream/stream/issues/351))
* Fix: Predefined date range intervals not honoring the site timezone setting ([#353](https://github.com/wp-stream/stream/issues/353))
* Fix: wpdb::prepare() notice appearing in WordPress 3.9 ([#354](https://github.com/wp-stream/stream/issues/354))
* Fix: Invalid argument warning thrown on fresh installations of WordPress ([#358](https://github.com/wp-stream/stream/issues/358))
* Fix: Record TTL purge not functioning correctly ([#371](https://github.com/wp-stream/stream/issues/371))
* Fix: Small CSS bug in jQuery UI datepicker skins ([04c80af](https://github.com/wp-stream/stream/commit/04c80afa99486086612be9f6ad83148dfbbe533a))
...
* New: Exclude tab in Settings to prevent specific types of activity from being tracked ([#251](https://github.com/wp-stream/stream/issues/251))
* New: Now logging Custom Background and Custom Header changes ([#309](https://github.com/wp-stream/stream/issues/309))
* New: Predefined date intervals now available when filtering records ([#320](https://github.com/wp-stream/stream/issues/320))
* Tweak: Action links are now available for Stream Settings records ([#305](https://github.com/wp-stream/stream/issues/305))
* Tweak: User avatars now displayed in Authors dropdown filter ([#311](https://github.com/wp-stream/stream/issues/311))
* Tweak: Live updates are enabled by default for new installs ([#312](https://github.com/wp-stream/stream/issues/312))
* Fix: Fallback to the term slug if a label does not exist in list-table ([#214](https://github.com/wp-stream/stream/issues/214))
* Fix: Widget sorting is now being tracked properly as well as Inactive widgets ([#283](https://github.com/wp-stream/stream/issues/283))
* Fix: Superfluous auto-draft posts are now prevented from being logged ([#293](https://github.com/wp-stream/stream/issues/293))
