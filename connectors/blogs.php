...
class MainWP_WP_Stream_Connector_Blogs extends MainWP_WP_Stream_Connector {
...
//		'update_blog_public',
	...
	public static function get_action_labels() {
		return array(
			...
			'archive_blog'  => __( 'Archived', 'mainwp-child-reports' ),
	...
	public static function action_links( $links, $record ) {
		...
		if ( $record->object_id ) {
			...
			if ( $site_settings_link ) {
				$links [ __( 'Site Settings', 'mainwp-child-reports' ) ] = $site_settings_link;
			}
		}
		return $links;
	}
	...
	public static function callback_make_spam_blog( $blog_id ) {
		self::callback_update_blog_status( $blog_id, __( 'marked as spam', 'mainwp-child-reports' ), 'updated' );
	}
	...
	public static function callback_make_ham_blog( $blog_id ) {
		self::callback_update_blog_status( $blog_id, __( 'marked as not spam', 'mainwp-child-reports' ), 'updated' );
	}
	...
	public static function callback_mature_blog( $blog_id ) {
		self::callback_update_blog_status( $blog_id, __( 'marked as mature', 'mainwp-child-reports' ), 'updated' );
	}
	...
	public static function callback_unmature_blog( $blog ) {
		self::callback_update_blog_status( $blog_id, __( 'marked as not mature', 'mainwp-child-reports' ), 'updated' );
	}
	...
	public static function callback_archive_blog( $blog ) {
		self::callback_update_blog_status( $blog_id, __( 'archived', 'mainwp-child-reports' ), 'archive_blog' );
	}
	...
	public static function callback_unarchive_blog( $blog_id ) {
		self::callback_update_blog_status( $blog_id, __( 'restored from archive', 'mainwp-child-reports' ), 'updated' );
	}
	...
	public static function callback_make_delete_blog( $blog_id ) {
		self::callback_update_blog_status( $blog_id, __( 'deleted', 'mainwp-child-reports' ), 'deleted' );
	}
	...
	public static function callback_make_undelete_blog( $blog_id ) {
		self::callback_update_blog_status( $blog_id, __( 'restored', 'mainwp-child-reports' ), 'updated' );
	}
	...
	public static function callback_update_blog_public( $blog_id, $value ) {
		if ( $value ) {
			$status = __( 'marked as public', 'mainwp-child-reports' );
		} else {
			$status = __( 'marked as private', 'mainwp-child-reports' );
		}
